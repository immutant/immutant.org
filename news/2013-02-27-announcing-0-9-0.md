...
* We finally tackled
  [one of our oldest outstanding issues](https://issues.jboss.org/browse/IMMUTANT-24).
  Because we now accept either a hash or a cron spec in our `schedule`
  function, the order of its args changed, so read the
  [at-jobs](/news/2013/02/27/at-jobs/) article for details.
